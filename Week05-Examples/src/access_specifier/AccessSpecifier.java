...
public class AccessSpecifier {
    public static void main(String[] args) {
        ...
        System.out.println(accessSpecifier2.sum(3,5));
        System.out.println("sum static " + AccessSpecifier2.sum2(3,6));     //  Static ise bu şekilde << çağırıyoruz!!
        // AccessSpecifier2.sum3(3,5) veya accessSpecifier2.sum3(3,5) -> compile error because of PROTECTED.
        // AccessSpecifierDefault.sum(3,5) compiler error because of not static! method
    ...
    private int sum2(int number1, int number2) {              //Private sadece aynı class içerisinden erişilebilirdir!!
        return number1+number2;
    }
}
